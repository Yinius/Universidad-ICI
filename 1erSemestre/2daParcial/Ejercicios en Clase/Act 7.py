#Ejercicio 7: Capture n números enteros positivos, obtenga la suma del cuadrado de los pares y el cubo de los impares
...
def generar_cuadrado():
    app.info(title="Resultado", text=f"La suma de los números pares es : {suma_p}\nLa suma de los números impares es: {suma_i}")
